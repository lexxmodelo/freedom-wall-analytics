...
- **Python 3.10+**
- The repo cloned, with `topic_modeling/outputs/` and `preprocessing/output/` already populated (the topic modeling phase must be complete first).
...
## 2. Configure your researcher slot (2 min)
